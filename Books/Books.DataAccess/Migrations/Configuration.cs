namespace Books.DataAccess.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Books.DataAccess.BooksAPIContext>
    {
        ...
        protected override void Seed(Books.DataAccess.BooksAPIContext context)
        {
